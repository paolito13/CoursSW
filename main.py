...
_ROOMS: list[tuple[str, list[str]]] = [
    ('La Cabane',                  ['cabane', 'dans', 'bectrille', 'la bectrille', 'nanis', 'etude de golmu', 'étude de golmue', 'la cabane', 'instritse phtiohs', 'année']),
    ...
    ('Salle de Littérature',       ['litter', 'littera', 'litterature', 'litteratur', 'literature', 'litteratur', 'fiqa', 'informis', 'divers', 'cuisine']),
...
_STOP = (
    ...
    r'|[Cc]r[eé]ature|[Mm]agique|[Cc]ours|[Hh]istoire|[Ll]itt[eé]rature|[Ll]eague\b|[Ee]n\b'
