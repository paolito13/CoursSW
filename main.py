...
_ROOMS: list[tuple[str, list[str]]] = [
    ...
    ('Salle DCFM (toilettes)',     ['dcfm', 'ocfm', 'toilette', 'saile', 'sox', 'soxis', 'morte', 'mortevsen', 'boianiqjje', 'botaniq', 'macte']),
    ...
    ("Salle d'Étude de Golmue",    ['golmue', 'golmu', 'golmve', 'etude de golm', 'study', 'golmus', 'sai e', 'sai', 'generaliste']),
]
...
_STOP = (
    ...
    r'|[Vv]ii\b|[Ee]me\b|[Éé]me\b|[Ee]re\b|[Éé]re\b|[Aa]nn[eé]e\b|secatr[a-z]*|[Aa]u\b|zito|[Cc][Ll][Ii][Nn][Tt][Aa][Ll][Ii][Ee][Nn]|SILAS|BENNETT|(?:^|\s)(?:[0-9]+\s*)?(?:[eèêé]m[eé]|[eèé]r[eé])\s+ann[eé]e'
